        ...
        <div className="animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <a 
              ...
              className="group bg-[#FF6B00] hover:bg-[#FF8A33] text-white font-montserrat font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-[#FF6B00]/50 flex items-center gap-2"
            >
              Iniciar Consultoria
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-transparent hover:bg-white/10 text-white font-montserrat font-bold px-8 py-4 rounded-lg text-lg border-2 border-white transition-all duration-300 transform hover:scale-105"
            >
              Tirar Dúvidas
            </a>
          </div>
