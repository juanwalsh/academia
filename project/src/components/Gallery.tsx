          ...
          {galleryItems.map((item, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-end p-6">
                <h3 className="font-montserrat font-bold text-2xl text-white transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                  {item.title}
                </h3>
              </div>
              <div className="absolute inset-0 border-4 border-[#FF6B00] opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl"></div>
            </div>
          ))}
        </div>
      </div>
